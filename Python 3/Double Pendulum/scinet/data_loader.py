...
def load(validation_size_p, file_name):
    ...
    training_data = data[0][:train_val_separation]
    training_states = states[0][:train_val_separation]
    validation_data = data[0][train_val_separation:]
    validation_states = states[0][train_val_separation:]
    f.close()
